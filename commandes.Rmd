...
- N'est pas sensible aux distributions des censures à droite.
...
- On peut choisir la borne maximal à la durée pour les calcul des rmst. C'est justement l'objet de cette commande que d'offrir les résultats des comparaisons pour toutes les durées où un évènement a été observé.
