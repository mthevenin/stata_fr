...
Fichier d'aide associé à la commande  
...
- **Installation**:  
Les 5 commandes sont installées directement avec:
```{}
...
**Estimations des durées de vie avec Stata et Stata** (voir ce que fait R):     
